...
<xsl:stylesheet
        ...
        <html>
            ...
            <body>
                ...
                <p class="intro">You are viewing an HTML version of the XML OAI response. To see the underlying XML use
                    your web browsers view source option. More information about this XSLT is at the<a href="#moreinfo">
                ...
                <p>An XSLT file has converted the
                    <a href="http://www.openarchives.org">OAI-PMH 2.0</a>
                    responses into XHTML which looks nice in a browser which supports XSLT such as Mozilla, Firebird and
                    Internet Explorer. The XSLT file was created by
                    <a href="http://www.ecs.soton.ac.uk/people/cjg">Christopher Gutteridge</a>
                    at the University of Southampton as part of the<a href="http://www.eprints.org/software/">GNU
    ...
    <xsl:template xmlns:ep="http://www.openarchives.org/OAI/1.1/eprints"
    ...
    <xsl:template match="oai:metadataFormat">
        ...
        <table class="values">
            <tr>
                ...
                <td class="value">
                    <a class="link" href="?verb=ListRecords&amp;metadataPrefix={oai:metadataPrefix}">
