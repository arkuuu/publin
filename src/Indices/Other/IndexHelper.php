...
class IndexHelper
{
     ...
     */
    public static function checkArrayKeysExist(
        array $keys,
        array $array,
        $checkLevel,
        $currentLevel,
     ...
     *
     * @return array The paths which are at least complete for $level.
     */
     ...
     * is not correct.
     */
    public static function checkDataTypesAreCorrect(
        array $dataTypes,
        array $array,
        $checkType,
        $checkLevel,
     ...
     */
    public static function convertWrongDataTypes(
        array $dataTypes,
        array $array,
        $conversionLevel,
        $currentLevel,
